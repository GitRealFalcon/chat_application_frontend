  ...
  return (
    <div className={`max-[900px]:w-screen h-screen backdrop-blur-sm max-[900px]:absolute w-[320px] ${!showUserInfo && "hidden"} `}>
      <div className=' flex justify-start items-center h-15 p-2'>
        <button className='cursor-pointer' onClick={handleClose}><img src={closeIcon} alt="close" /></button>
      </div>
      <div className=' pt-10'>
        <div className='flex flex-col gap-2 justify-center items-center'>
          <div className='w-24 h-24 border-2 rounded-full flex items-center justify-center'><img src={personIcon} alt="person" /></div>
